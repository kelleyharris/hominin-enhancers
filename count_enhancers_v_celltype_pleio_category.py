...
if popul=='all':
    outfile=open('allpop_analysis/allpops_'+species+'_'+oneortwo+'_counts_v_celltype_pleio_number.txt','w')
elif oneortwo=='both':
    outfile=open(popul+'_1minus2_analysis/'+popul+'_1minus2_counts_v_celltype_pleio_number.txt','w')
elif oneortwo=='minus':
    outfile=open('bugtest_1minus2/'+popul+'_'+species+'_1minus2_counts_v_celltype_pleio_number.txt','w')
else:
    outfile=open(popul+'_'+species+oneortwo+'_analysis/'+popul+'_'+species+oneortwo+'_counts_v_celltype_pleio_number.txt','w')
