...
#plt.text(0.85,1.09,r'$r^2=$'+str(0.001*int(1000*rval**2))+', p<'+str(0.00001*int(100000*pval)),color='grey')

if species=='denisova':
    plt.xlim(xmin=0.6)
    plt.xlim(xmax=1.05)
    plt.text(0.7,1.045,r'$r^2=$'+str(0.001*int(1000*rval**2))+',\n p<'+str(0.00001*int(100000*pval)),color='grey')
else:
    plt.xlim(xmin=0.75)
    plt.xlim(xmax=0.95)
    plt.text(0.8,1.05,r'$r^2=$'+str(0.001*int(1000*rval**2))+',\n p<'+str(0.00001*int(100000*pval)),color='grey')
...
plt.savefig('allpop_analysis/allcelltypes_fetal_adult_odds'+species+'_v_oddsrare_wfit.png')
